    ...
    <div className="space-y-10">
      ...
      <section className="rounded-xl border border-neutral-200 bg-white p-5">
        ...
        <div className="mt-3 space-y-3 leading-7 text-neutral-700">
          ...
          <p>
            검진 일정과 정부 지원 제도는 지역, 소득 기준, 의료기관, 신청 시점에 따라 달라질 수 있습니다.
            따라서 글을 읽은 뒤에는 산부인과 안내문, 보건소 공지, 국민건강보험 안내, 정부24 신청
            페이지를 다시 확인하는 것이 안전합니다. 임신 초기에는 증상을 인터넷 정보로 단정하지 말고
            진료 예약과 응급 상담 경로를 먼저 확보해야 하며, 출산 준비 비용도 실제 거주지와 병원 정책을
            기준으로 다시 계산해야 합니다.
          </p>
          <p>
            이 사이트의 보험·지원금·생활관리 글은 준비 체크리스트를 만들기 위한 참고 자료입니다.
            특정 상품 가입을 권유하거나 개인의 건강 상태를 판단하지 않습니다. 사용자는 본문에서 제시한
            질문 목록을 바탕으로 의료진에게 확인할 내용을 정리하고, 가족과 공유할 일정, 신청 서류,
            긴급 연락처, 산후 지원 계획을 별도로 기록해 두는 방식으로 활용하는 것이 좋습니다.
          </p>
        </div>
      </section>
    </div>
